 ...
 */
public class PageDataExtend<T> implements Serializable {
    ...
    public PageDataExtend() {

    }

    public PageDataExtend(List<T> results, int pageNum, int pageSize, int recordPage) {
