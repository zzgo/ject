...
import com.zzgo.jeck.query.Criterion.MatchMode;
import com.zzgo.jeck.query.Criterion.Operator;
...
public class Restrictions {
    ...
    public static SimpleExpression like(String fieldName, String value) {
        if (value.equals(null))
            return null;
        return new SimpleExpression(fieldName, value, MatchMode.ANYWHERE, Operator.LIKE);
    }
